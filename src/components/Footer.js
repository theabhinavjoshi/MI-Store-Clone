  ...
  return (
    <>
        ...
        <div className="PreFooter">
            ...
            <div>
                {shieldIcon}
                <p><b>100% secure payments</b><br />We support Cash, Card, EMI, QR</p>
            </div>
            <div>
                {mapIcon}
                <p><b>Vast service network</b><br />1000 MI Stores across country</p>
            </div>
        </div>
        ...
        <div className="PreFooter2">
            <div>
                ...
                <span>Get updates on special sales and more</span>
            </div>
            ...
            <div>
                ...
                <span>Thanks. You are on our email list for offers.</span>
            </div>
